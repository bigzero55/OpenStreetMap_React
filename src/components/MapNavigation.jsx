...
const MapNavigation = () => {
    ...
    const markers = [
        ...
        { position: [-6.968649211031864, 107.62717608491147], name: 'Pondok Izzati' },
        { position: [-6.968550703904539, 107.62852936076335], name: 'OYO Socialite' },
        { position: [-6.968613390259261, 107.6263641193572], name: 'warung pak agus' },
  ...
  return (
    ...
    <MapContainer center={PositionPuebla} zoom={16} style={{ height: '92vh', width: '100%' }} >
      <TileLayer
